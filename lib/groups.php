...
function groups_handle_profile_page($guid) {
	...
	$group_header = elgg_view('groups/profile/summary', array('entity' => $group));
	...
	if (elgg_group_gatekeeper(false)) {
		...
		$sidebar .= '<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.';
		$sidebar .= '<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>.<br>test pour voir si ça suit le scroll';
	...
	$params = array(
		...
		'content' => $content,
		'sidebar' => $sidebar,
		'class' => 'elgg-group-layout elgg-group-' . $group->getGUID(),
		'filter' => false,
		//'title' => $group->name,
	);
	$body = elgg_view_layout('group', $params);
